    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".gallery__slider")) {
                let swiperGalleryInfo = new Swiper(".info-gallery__slider", {
            ...
            if (document.querySelector(".more__slider")) new Swiper(".more__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".hero__slider-swiper")) new Swiper(".hero__slider-swiper", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".arcollection-slider")) new Swiper(".arcollection-slider", {
        ...
        addEventListener("DOMContentLoaded", (event => {
            ...
            if (searchItem && searchBtnOpen) {
                ...
                const searchBody = searchItem.querySelector(".search__body");
                searchBtnOpen.addEventListener("click", (function(e) {
                    document.documentElement.classList.add("open-search");
                }));
                if (searchBtnClose) searchBtnClose.addEventListener("click", (function(e) {
                    if (document.documentElement.classList.contains("open-search")) {
                        document.documentElement.classList.remove("open-search");
                        if (document.documentElement.classList.contains("lock")) if (!document.documentElement.classList.contains("menu-open")) document.documentElement.classList.remove("lock");
                        if (resultSearchBox.classList.contains("_active")) resultSearchBox.classList.remove("_active");
                    }
                }));
                document.addEventListener("click", (function(e) {
                    if (document.documentElement.classList.contains("open-search")) if (!searchBody.contains(e.target) && !searchBtnOpen.contains(e.target)) if (!resultSearchBox.classList.contains("_active")) {
                        document.documentElement.classList.remove("open-search");
            ...
            if (videoPlayBtn && video && videoStopBtn) {
                ...
                videoStopBtn.addEventListener("click", (function(e) {
                    video.pause();
                    if (document.documentElement.classList.contains("_video-play")) document.documentElement.classList.remove("_video-play");
                }));
            }
            function handleScrollAndResize() {
                if (window.innerWidth >= 991.98) setTimeout((() => {
                    document.addEventListener("scroll", onScrollHandler);
                }), 1e3); else document.removeEventListener("scroll", onScrollHandler);
            }
            function onScrollHandler() {
                ...
                if (selection) {
                    ...
                    if (rect.top <= windowHeight - offset && rect.bottom > windowHeight - offset) {
                        if (wrapperText) wrapperText.classList.add("_active");
                    } else if (rect.bottom <= windowHeight - offset) {
                        if (wrapperText) wrapperText.classList.remove("_active");
                    } else if (rect.top > windowHeight - offset) if (wrapperText) wrapperText.classList.remove("_active");
                }
            }
